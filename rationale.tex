...
As shown in Figure \ref{fig:full}, I'm having trouble with the relative magnitude of each of the curves. In an attempt to get to the bottom of the problem, I've described in detail (see sections below) how each of the curves was calculated. Here's a few notes on my approach:
\begin{itemize}
...
htc-hfds-ohc_Oyr_NorESM1-M_rcp85_r1i1p1_all_nummelin.png
\end{verbatim}
