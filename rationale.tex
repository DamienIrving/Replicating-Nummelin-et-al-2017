...
For my initial attempt (see Figure \ref{fig:noresm_full} and the methodology described in detail in the appendices below), I regrid from a curvilinear to rectilinear grid at some point to simplify the process. I also present the results in units of $W\; s^{-1}$ (as opposed to $W\; m^{-2}\; s^{-1}$), as it's difficult for me to divide the final result by area because once the data is regridded I can't use the relevant areacello file.
